...
st.title('**Welcome!**')
st.write('This app displays stock price predictions generated by a SARIMA model. Choose a stock symbol as listed on the [Yahoo! Finance website](https://finance.yahoo.com/lookup/).')
#------------------------------------------------------------------------------#
